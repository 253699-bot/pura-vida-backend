...
public record WeeklyReportOrdersSummary(long pendientes, long aceptados, long rechazados) {

    public static WeeklyReportOrdersSummary from(DashboardOrdersResponse orders) {
        return new WeeklyReportOrdersSummary(orders.pendientes(), orders.aceptados(), orders.rechazados());
    }
}
